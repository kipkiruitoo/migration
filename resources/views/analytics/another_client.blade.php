...
// datas.pages.forEach()
let obj1 = datas.pages.find(o => o.name === 'C Questions')

//let obj = datas.pages.find(o => o.name === 'SC QUESTIONS')
let obj = datas.pages.find(o => o.name === 'page1')
let obj2 = datas.pages.find(o => o.name === 'NK QUESTIONS')
let obj3 = datas.pages.find(o => o.name === 'Introduction2021')
// console.log(obj)
