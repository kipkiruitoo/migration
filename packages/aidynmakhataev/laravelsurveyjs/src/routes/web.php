...
Route::group(
    ...
    function () {
        Route::post('/{surveySlug}', 'SurveyController@runSurvey')->name('survey-manager.run');
    }
);
Route::group(
    [
    ...
    function () {
        Route::view('{vue?}', 'survey-manager::admin')->where('vue', '[\/\w\.-]*')->name('survey-manager.admin')->middleware('auth');
    }
);
